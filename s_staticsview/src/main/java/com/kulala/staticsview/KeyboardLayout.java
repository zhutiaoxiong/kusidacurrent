...
//        keyboard_layout.setKeyboardListener(new KeyboardLayout.KeyboardLayoutListener() {
//            @Override
//            public void onKeyboardStateChanged(boolean isActive, int keyboardHeight) {
//                RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, ODipToPx.dipToPx(getContext(),160));
//                params.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM, 1);//底
//                if(isActive){
//                    params.setMargins(0,0,0,keyboardHeight);
//                }
//                lin_all.setLayoutParams(params);
//            }
//        });
