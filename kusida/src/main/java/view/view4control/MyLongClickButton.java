...
public class MyLongClickButton extends androidx.appcompat.widget.AppCompatButton {
    ...
    public MyLongClickButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyLongClickButton(Context context, AttributeSet attrs, int defStyleAttr) {
