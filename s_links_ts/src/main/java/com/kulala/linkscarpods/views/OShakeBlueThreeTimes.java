...
public class OShakeBlueThreeTimes {
    ...
    // ========================out======================
    private static OShakeBlueThreeTimes _instance;
...
//                    Log.i(">>>OShakeBlue>>>", "speed 6:");
            if (carInfo.isTheft == 0) {//铁秋要求isLock改为isTheft,撤防0 执行设防，isTheft 1,2,3其它的都算设防
    ...
    private final BroadcastReceiver mBatInfoReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (Intent.ACTION_SCREEN_OFF.equals(action)) {
                ...
                if(screenOnTime==0||screenOffTime==0||Math.abs(screenOffTime-screenOnTime)<5000){
                    testNum++;
                }
                isScreenOff = true;
...
//            testTime = now;
    ...
    private static long              CAN_SHAKE_TIME     = 2500L;
    // 停止监听器
    ...
    private static final double SPEED_SHRESHOLD      = 7;//这个值调节灵敏度
