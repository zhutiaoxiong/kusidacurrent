...
//                scanLeDevice(context,false,null,onScanBlueListener);//关闭搜索
            if (BuildConfig.DEBUG) Log.e("blue","scanLeDevice Func:扫到设备:"+device.getAddress());
...
//            }
        ...
        public void onBatchScanResults(List<ScanResult> results) {
            ...
            if (BuildConfig.DEBUG) Log.e("blue","scanLeDevice Func:扫到设备列表:");
            for (int i = 0; i <results.size() ; i++) {
                if (BuildConfig.DEBUG) Log.e("blue","scanLeDevice Func:扫到设备列表:"+results.get(i).getDevice().getName());
            }
        }
    };
